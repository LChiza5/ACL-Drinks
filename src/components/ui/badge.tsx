  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        sale: "border-transparent bg-gradient-to-r from-hibiscus-600 to-hibiscus-400 text-white font-bold",
        new: "border-transparent bg-gradient-to-r from-emerald-600 to-emerald-400 text-white font-bold",
      },
    },
