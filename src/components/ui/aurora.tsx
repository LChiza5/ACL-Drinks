...
export function Aurora({
  ...
  useEffect(() => {
    ...
    // Some browsers/devices have WebGL disabled or blocked (privacy settings, software
    // rendering off, older mobile GPUs). ogl doesn't guard against a null context, so we do:
    // fall back to the static gradient already behind this component instead of crashing.
