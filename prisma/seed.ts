  ...
  const categories = await Promise.all([
    prisma.category.upsert({
      ...
      create: {
        ...
        color: "#f59e0b",
        sortOrder: 1,
        image: "/catalog/products/johnnie-walker-black-label.webp",
      },
    }),
    prisma.category.upsert({
      where: { slug: "ron" },
      ...
      create: {
        ...
        color: "#a855f7",
        sortOrder: 2,
        image: "/catalog/products/cacique-ron-anejo.webp",
      },
    }),
    prisma.category.upsert({
      where: { slug: "vodka" },
      ...
      create: {
        ...
        color: "#3b82f6",
        sortOrder: 3,
        image: "/catalog/products/absolut-vodka-original.webp",
      },
    }),
    prisma.category.upsert({
      where: { slug: "tequila" },
      ...
      create: {
        ...
        color: "#10b981",
        sortOrder: 4,
        image: "/catalog/products/jose-cuervo-especial.webp",
      },
    }),
    prisma.category.upsert({
      where: { slug: "cervezas" },
  ...
  const products = await Promise.all([
    prisma.product.upsert({
      ...
      create: {
        ...
        price: 18500,
        comparePrice: 22000,
        images: ["/catalog/products/johnnie-walker-red-label.webp"],
    ...
    prisma.product.upsert({
      ...
      create: {
        ...
        price: 15000,
        images: ["/catalog/products/cacique-ron-anejo.webp"],
    ...
    prisma.product.upsert({
      ...
      create: {
        ...
        price: 16500,
        comparePrice: 19000,
        images: ["/catalog/products/absolut-vodka-original.webp"],
    ...
    prisma.product.upsert({
      ...
      create: {
        ...
        price: 14500,
        images: ["/catalog/products/jose-cuervo-especial.webp"],
    ...
    prisma.product.upsert({
      ...
      create: {
        ...
        price: 5500,
        comparePrice: 6500,
        images: [], // sin foto verificada del six pack Imperial - ver docs/IMAGENES.md
    ...
    prisma.product.upsert({
      ...
      create: {
        ...
        price: 28000,
        comparePrice: 32000,
        images: ["/catalog/products/johnnie-walker-black-label.webp"],
        categoryId: categories[0].id,
        brand: "Johnnie Walker",
        alcoholContent: 40,
        volume: "750ml",
